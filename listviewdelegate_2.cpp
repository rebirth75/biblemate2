...
QSize ListViewDelegate_2::iconSize = QSize(10, 10);
int ListViewDelegate_2::padding = 1;
//int fontsize, titlesize;

ListViewDelegate_2::ListViewDelegate_2(int fs, int ts)
{
    ListViewDelegate_2::fontsize=fs;
    ListViewDelegate_2::titlesize=ts;
}

ListViewDelegate_2::~ListViewDelegate_2()
{
}

QSize ListViewDelegate_2::sizeHint(const QStyleOptionViewItem &  option ,
...
void ListViewDelegate_2::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    if(!index.isValid())
        return;
